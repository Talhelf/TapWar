...
- **Entitlements File**: `Config/TapWar.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/TapWar.entitlements`:
